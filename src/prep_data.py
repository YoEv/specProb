...
def simplify_chord(chord_label):
    ...
    # Let's try to map '7' to 'maj' if we want "major/minor" classification.
    # However, plan says "12 roots x {major, minor} + N".
    # Let's map 7 to maj for now, as it has a major third.
