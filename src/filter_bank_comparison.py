...
def run_granular_band_analysis(X_freq, y):
    ...
    print(f"Baseline Accuracy (All Bands): {acc_full:.4f}")
...
def run_mel_scale_analysis(X_freq, y):
    ...
    print(f"Accuracy on {n_mels} Mel-Scale features: {accuracy:.4f}")
    print("---------------------------------------------------------------------")
...
def run_log_scale_analysis(X_freq, y):
    ...
    print(f"Accuracy on {log_filters.shape[0]} Log-Scale features: {accuracy:.4f}")
    print("---------------------------------------------------------------------")
